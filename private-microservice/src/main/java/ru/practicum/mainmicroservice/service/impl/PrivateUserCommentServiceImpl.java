...
@Service
public class PrivateUserCommentServiceImpl implements PrivateUserCommentService {
    final CommentRepository commentRepository;
    final UserRepository userRepository;
    final EventRepository eventRepository;

    public PrivateUserCommentServiceImpl(CommentRepository commentRepository, UserRepository userRepository,
