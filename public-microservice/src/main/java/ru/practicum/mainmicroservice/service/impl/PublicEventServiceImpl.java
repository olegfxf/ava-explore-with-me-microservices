...
import ru.practicum.mainmicroservice.service.PublicEventService;
...
public class PublicEventServiceImpl implements PublicEventService {
    ...
    private void saveHitsWrap(Event event, HttpServletRequest request) throws IOException, InterruptedException {
        HitDto hitDto = statsServer.saveHit(request);
        event.setViews(hitDto.getHit());
        eventRepository.save(event);
    }
