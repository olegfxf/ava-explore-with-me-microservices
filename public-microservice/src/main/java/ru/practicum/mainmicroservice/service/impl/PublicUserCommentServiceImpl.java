...
import ru.practicum.mainmicroservice.service.PublicUserCommentService;
...
@Service
public class PublicUserCommentServiceImpl implements PublicUserCommentService {
    final CommentRepository commentRepository;
    final EventRepository eventRepository;

    public PublicUserCommentServiceImpl(CommentRepository commentRepository,
